 ...
 */
Menu::MenuItem::MenuItem(int itemType, MenuData data, char* label, IDelegate1<Menu&>* confirmCallback)
{
	mIsEnabled = true;
	mLabel     = label;
 ...
 */
void Menu::addOption(MenuData data, char* label, IDelegate1<Menu&>* confirmCallback, bool isEnabled)
{
	// set up new item
 ...
 */
void Menu::addMenu(Menu* subMenu, MenuData data, char* label)
{
