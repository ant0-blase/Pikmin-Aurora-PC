...
void P2DWindow::loadResource()
{
	...
	OSReport("[pikmin::p2d-res] window begin pane=%p tag=%08x tl=%s tr=%s bl=%s br=%s\n",
	         this, mTagName,
	         mTLTexName ? mTLTexName : "<null>", mTRTexName ? mTRTexName : "<null>",
	         mBLTexName ? mBLTexName : "<null>", mBRTexName ? mBRTexName : "<null>");
#endif
...
#if defined(TARGET_PC)
	OSReport("[pikmin::p2d-res] window ok pane=%p min=%dx%d\n", this, mMinWidth, mMinHeight);
#endif
}
