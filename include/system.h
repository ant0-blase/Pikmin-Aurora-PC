...
public:
	...
	virtual u32 copyRamToCache(uptr, u32, u32) { return 0; }                                                             // _10
	virtual void copyCacheToRam(uptr, u32, u32) { }                                                                      // _14
...
public:
	...
	virtual u32 copyRamToCache(uptr, u32, u32);                                                       // _10
	virtual void copyCacheToRam(uptr, u32, u32);                                                      // _14
	virtual void copyWaitUntilDone();                                                                // _18
	virtual void copyCacheToTexture(CacheTexture*);                                                  // _1C
#if defined(VERSION_PIKIDEMO)                                                                        //
...
struct AramStream : public RandomAccessStream {
	...
	virtual void read(void* data, int size)       // _3C (weak)
	{
		...
		gsys->copyCacheToRam((uptr)data, mBaseAddress + mOffset, readSize);
