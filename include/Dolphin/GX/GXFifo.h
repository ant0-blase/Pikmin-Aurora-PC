...
// Aurora owns the host-side GX command stream. Direct writes to 0xCC008000
// are GameCube MMIO and must never be emitted by a native process.
...
void GXColor1u32(u32 colour);
void GXColor1u16(u16 colour);
