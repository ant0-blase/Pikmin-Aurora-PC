...
// Aurora implements the portable Dolphin matrix entry points on host platforms.
// Do not select the PowerPC paired-singles symbols used by the original retail SDK.
