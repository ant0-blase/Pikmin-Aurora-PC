...
// Clock speeds. The original SDK reads these from fixed GameCube memory.
// Native builds use the hardware frequencies as constants so no emulated
// low-memory symbol is required by the linker.
