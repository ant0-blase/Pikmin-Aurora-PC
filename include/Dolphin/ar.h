...
typedef void (*ARQCallback)(uptr ptrToRequest);
...
void ARQInit();
void ARQPostRequest(ARQRequest* task, u32 owner, u32 type, u32 priority, uptr source, uptr dest, u32 length, ARQCallback callback);
