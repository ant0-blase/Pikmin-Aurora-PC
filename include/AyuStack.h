...
public:
	...
	void init(uptr bufferStart, uptr bufferEnd);
...
public:
	...
	uptr mInitialStackTop;   // _0C, base pointer for upward growth
	uptr mInitialStackLimit; // _10, base pointer for downward growth
	uptr mStackTop;          // _14, current top when growing upward
	uptr mStackLimit;        // _18, current limit when growing downward
